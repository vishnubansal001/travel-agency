      ...
      <div className="relative my-16 md:mb-7">
        <div className="travigo-container flex items-center justify-between gap-16 xl:gap-9 lg:flex-col-reverse">
          ...
          <div className="grid items-center w-full max-w-2xl lg:text-center">
            <h1 className="text-5xl lg:text-4xl md:3xl font-bold to-slate-900 filter drop-shadow-lg">
              {title}
            </h1>
            <h1 className="text-5xl lg:text-4xl md:3xl font-bold to-slate-900 filter drop-shadow-lg">
              {subtitle}
            ...
            <div className="grid items-center grid-cols-3 gap-7 xl:gap-3">
              {experience?.map((val, i) => (
                <div key={i} className=" bg-gradient-to-b from-emerald-300 to-green-300 shadow-lg shadow-emerald-200 flex items-center justify-center flex-col py-7 px-5 xl:p-4 rounded-lg text-slate-900 filter transition-transform duration-500 hover:scale-105 cursor-pointer">

  ...
  return (
    <>
      <div className="relative w-full max-w-5xl ml-auto mr-auto mt-0 mb-3 xl:w-[95vw] rounded-lg">
        ...
        <div className="absolute top-20 left-12 w-full flex flex-col items-start md:items-center md:justify-center md:left-0 md:top-14">
          <h1 className="font-bold text-3xl text-slate-900 drop-shadow-lg filter">
            {title}
          </h1>
